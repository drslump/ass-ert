...
var defProp = _.bind(Object.defineProperty, Object);
...
function Chain (value) {
  ...
  this.test = _.bind(Chain.prototype.test, this);
  this.assert = _.bind(Chain.prototype.assert, this);
  this.result = _.bind(Chain.prototype.result, this);
  this.through = _.bind(Chain.prototype.through, this);
  this.$ = this.through;
}
...
proto.test = function (actual) {
  ...
  // Assume incomplete runs are valid
...
proto.assert = function (actual, ssf) {
  ...
  try {
    ...
    if (result === false) {
      throw this.buildError(resolver.done, ssf || this.assert);
    }
  } finally {
    resolvers.release(resolver);
  }
